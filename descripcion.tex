...
tan sencillas de usar en diferentes etapas del desarrollo del sistema, debido 
...
aplicaci\'on de los sistemas embebidos, es indispensable garantizar la 
confiabilidad de su funcionamiento haciendo uso combinado de dos metodolog\'ias 
...
formales?
\item ¿Cu\'al lenguaje formal permite expresar un sistema a trav\'es de 
...
no tenga ambigüedades y que se pueda manipular f\'acilmente para optimizar, 
...
errores por ambigüedades en la descripci\'on, el cual posteriormente ser\'a 
...
de un lenguaje que no posea ambigüedades adem\'as de soportarlo la herramienta 
...
desarrollo del mismo y de forma serial usando SDL, MSC y TTCN3.
